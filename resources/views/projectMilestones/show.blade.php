<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-green-700 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="space-y-6">
                        <div class="bg-green-100 dark:bg-blue-700 p-4 rounded-lg shadow-sm">
                        ...
                        <div class="bg-green-100 dark:bg-blue-700 p-4 rounded-lg shadow-sm">
                            ...
                            <p class="text-gray-700 dark:text-gray-300">{{ $projectMilestone->updated_at ? $projectMilestone->updated_at->format('Y-m-d H:i:s') : 'Not Updated' }}</p>
                        </div>
                    </div>

                    <div class="mt-6">
                        <a href="{{ route('projectMilestones.index') }}" class="px-6 py-2 bg-green-600 hover:bg-blue-700 text-white rounded-lg shadow-md">
                            Back to Milestones
                        </a>
                    </div>
                </div>
